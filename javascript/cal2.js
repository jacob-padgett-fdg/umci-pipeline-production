...
function BrowseDate(input_id) {
	today=new Date();
	_cal_today_day=today.getDate();
	_cal_today_month=today.getMonth();
	_cal_today_year=today.getFullYear();
...
function CalendarCallback(strSelectedDate,input_id) {
	...
	input_field=document.getElementById(input_id).value=(date.getMonth()+1)+"/"+date.getDate()+"/"+date.getFullYear();
