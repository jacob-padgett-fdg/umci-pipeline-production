 ...
 */
function bizway_image_resize($img_url, $width, $height, $crop = true, $quality = 100) {
 ...
 * @return type 
 */
function bizway_thumbnail_resize($attach_id = null, $img_url = null, $width, $height, $crop = false, $jpeg_quality = 90) {
